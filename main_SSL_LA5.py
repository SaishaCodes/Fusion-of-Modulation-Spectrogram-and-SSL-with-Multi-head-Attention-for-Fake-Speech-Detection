...
import yaml
from data_utils_SSL import genSpoof_list,Dataset_ASVspoof2019_train_ms,Dataset_ASVspoof2021_eval_ms
...
if __name__ == '__main__':
    ...
    if not os.path.exists('models_seed=10'):
        os.mkdir('models_seed=10')
    ...
    model_save_path = os.path.join('models_seed=10', model_tag)
    ...
    if args.eval:
        ...
        eval_set=Dataset_ASVspoof2021_eval_ms(list_IDs = file_eval,base_dir = os.path.join(args.database_path+'ASVspoof2021_{}_eval/'.format(args.track)))
    ...
    train_set=Dataset_ASVspoof2019_train_ms(args,list_IDs = file_train,labels = d_label_trn,base_dir = os.path.join(args.database_path+'{}_{}_train/'.format(prefix_2019.split('.')[0],args.track)),algo=args.algo)
    ...
    dev_set = Dataset_ASVspoof2019_train_ms(args,list_IDs = file_dev,
		labels = d_label_dev,
